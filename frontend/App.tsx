...
function App() {
            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12">
              <div className="gradient-careermap rounded-[2.5rem] p-14 md:p-24 text-center relative overflow-hidden shadow-2xl shadow-teal-500/25">
                ...
                <p className="text-white/70 text-lg md:text-xl font-medium max-w-2xl mx-auto mb-12 relative z-10 leading-relaxed">
                  Join {systemStats.students.toLocaleString()}+ BiT students using AI-powered intelligence to bridge the gap between classroom and career.
                </p>
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
      <Navbar onNavigate={navigateTo} currentView={view} theme={theme} onToggleTheme={toggleTheme} />
      <main>
        {renderContent()}
      </main>
